function Features() {
  return (
    <div className="pt-10 md:pt-20 mx-5">
      <h1 className="text-center text-blue-400 text-2xl sm:text-4xl font-bold">
        Why{" "}
        <span className="text-white bg-blue-400 rounded-xl p-2">
          online billing?
        </span>
      </h1>
      <div className="container flex flex-col items-center py-10 space-y-2 md:flex-row md:mx-auto md:space-x-5 md:px-20 md:mb-10 md:justify-around">
        <div className="flex items-center bg-blue-400 rounded-2xl p-6 w-full duration-150 md:h-48 md:px-0 hover:scale-105 cursor-pointer">
